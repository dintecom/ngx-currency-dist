...
class InputManager {
    ...
    get canInputMoreNumbers() {
        var _a, _b;
        const onlyNumbers = (_b = (_a = this.rawValue) === null || _a === void 0 ? void 0 : _a.replace(/[^0-9\u0660-\u0669\u06F0-\u06F9]/g, '')) !== null && _b !== void 0 ? _b : '';
    ...
    get inputSelection() {
        var _a, _b;
        return {
            selectionStart: (_a = this._htmlInputElement.selectionStart) !== null && _a !== void 0 ? _a : 0,
            selectionEnd: (_b = this._htmlInputElement.selectionEnd) !== null && _b !== void 0 ? _b : 0,
        };
    }
    get rawValue() {
    ...
    set rawValue(value) {
        ...
        if (this._htmlInputElement) {
            this._htmlInputElement.value = value !== null && value !== void 0 ? value : '';
        }
    }
    get storedRawValue() {
...
class InputService {
    ...
    changeToNegative() {
        ...
        if (this._options.allowNegative /*&& this.rawValue != ""*/ &&
            ((_a = this.rawValue) === null || _a === void 0 ? void 0 : _a.charAt(0)) != '-' /*&& this.value != 0*/) {
    ...
    changeToPositive() {
        var _a, _b;
        // Apply the mask to ensure the min and max values are enforced.
        this.rawValue = this.applyMask(false, (_b = (_a = this.rawValue) === null || _a === void 0 ? void 0 : _a.replace('-', '')) !== null && _b !== void 0 ? _b : '');
    }
    removeNumber(keyCode) {
        ...
        const suffixStart = ((_b = (_a = this.rawValue) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) - suffix.length;
        ...
        let decimalIndex = (_d = (_c = this.rawValue) === null || _c === void 0 ? void 0 : _c.indexOf(decimal)) !== null && _d !== void 0 ? _d : -1;
        if (decimalIndex === -1) {
            decimalIndex = (_f = (_e = this.rawValue) === null || _e === void 0 ? void 0 : _e.length) !== null && _f !== void 0 ? _f : 0;
        }
        ...
        if (selectionEnd === selectionStart) {
            if (keyCode == 8) {
                ...
                if (!((_g = this.rawValue) === null || _g === void 0 ? void 0 : _g.substring(selectionStart, selectionStart + 1).match(/\d/))) {
                    selectionStart--;
                }
                ...
                if (!((_k = this.rawValue) === null || _k === void 0 ? void 0 : _k.substring(selectionStart, selectionStart + 1).match(/\d/))) {
                    selectionStart++;
                    selectionEnd++;
                }
            }
        ...
        let selectionFromEnd = ((_m = (_l = this.rawValue) === null || _l === void 0 ? void 0 : _l.length) !== null && _m !== void 0 ? _m : 0) - selectionEnd;
        this.rawValue =
            ((_o = this.rawValue) === null || _o === void 0 ? void 0 : _o.substring(0, selectionStart)) +
                insertChars +
                ((_p = this.rawValue) === null || _p === void 0 ? void 0 : _p.substring(selectionEnd));
    ...
    updateFieldValue(selectionStart, disablePadAndTrim = false) {
        ...
        const newRawValue = this.applyMask(false, (_a = this.rawValue) !== null && _a !== void 0 ? _a : '', disablePadAndTrim);
        selectionStart !== null && selectionStart !== void 0 ? selectionStart : (selectionStart = (_c = (_b = this.rawValue) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0);
        selectionStart = Math.max(this._options.prefix.length, Math.min(selectionStart, ((_e = (_d = this.rawValue) === null || _d === void 0 ? void 0 : _d.length) !== null && _e !== void 0 ? _e : 0) - this._options.suffix.length));
        this.inputManager.updateValueAndCursor(newRawValue, (_g = (_f = this.rawValue) === null || _f === void 0 ? void 0 : _f.length) !== null && _g !== void 0 ? _g : 0, selectionStart);
    }
...
class InputHandler {
    ...
    handleInput() {
        var _a;
        const rawValue = (_a = this.inputService.rawValue) !== null && _a !== void 0 ? _a : '';
        ...
        if (keyCode == 8 || keyCode == 46 || keyCode == 63272) {
            ...
            if (this.inputService.inputSelection.selectionStart <=
                ...
                this.inputService.inputSelection.selectionEnd >=
                    ((_b = (_a = this.inputService.rawValue) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0) -
        ...
        switch (keyCode) {
            ...
            default:
                if (this.inputService.canInputMoreNumbers) {
                    ...
                    if (selectionRangeLength == ((_b = (_a = this.inputService.rawValue) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0)) {
                        this.setValue(null);
                    }
...
class NgxCurrencyDirective {
    constructor(globalOptions, keyValueDiffers, _elementRef) {
        ...
        this.options = {};
        this._optionsTemplate = Object.assign({ align: 'right', allowNegative: true, allowZero: true, decimal: '.', precision: 2, prefix: '$ ', suffix: '', thousands: ',', nullable: false, inputMode: NgxCurrencyInputMode.Financial }, globalOptions);
        this._keyValueDiffer = keyValueDiffers.find({}).create();
    }
    ngOnInit() {
        this._inputHandler = new InputHandler(this._elementRef.nativeElement, Object.assign(Object.assign({}, this._optionsTemplate), this.options));
    }
    ngAfterViewInit() {
        var _a, _b;
        this._elementRef.nativeElement.style.textAlign =
            (_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.align) !== null && _b !== void 0 ? _b : this._optionsTemplate.align;
    }
    ngDoCheck() {
        var _a, _b;
        if (this._keyValueDiffer.diff(this.options)) {
            this._elementRef.nativeElement.style.textAlign =
                (_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.align) !== null && _b !== void 0 ? _b : this._optionsTemplate.align;
            this._inputHandler.updateOptions(Object.assign(Object.assign({}, this._optionsTemplate), this.options));
        }
    }
    handleBlur(event) {
...
NgxCurrencyDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "15.2.1", ngImport: i0, type: NgxCurrencyDirective, deps: [{ token: NGX_CURRENCY_CONFIG, optional: true }, { token: i0.KeyValueDiffers }, { token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
NgxCurrencyDirective.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "15.2.1", type: NgxCurrencyDirective, isStandalone: true, selector: "[currencyMask]", inputs: { options: "options" }, host: { listeners: { "blur": "handleBlur($event)", "cut": "handleCut()", "input": "handleInput()", "keydown": "handleKeydown($event)", "keypress": "handleKeypress($event)", "paste": "handlePaste()", "drop": "handleDrop($event)" } }, providers: [
        {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.2.1", ngImport: i0, type: NgxCurrencyDirective, decorators: [{
            type: Directive,
            args: [{
                    standalone: true,
        ...
        return [{ type: undefined, decorators: [{
                    ...
                    }] }, { type: i0.KeyValueDiffers }, { type: i0.ElementRef }];
